...
<html>
<head>
    <title>${phone.phoneName}商品信息修改</title>
...
<div class="container">
    <div class="row row-offcanvas row-offcanvas-right">
        <form class="form-horizontal" method="post" action="/doUpdateSku">
            <fieldset>
                <div id="legend" class="">
                ...
                <div class="control-group">
                    <div class="controls">
                        <input name="skuId" type="text" placeholder="小米5" class="input-xlarge" id="input00" value="${phone.id}" hidden>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="skuName" type="text" placeholder="小米5" class="input-xlarge" id="input01" value="${phone.phoneName}">
                ...
                <div class="controls">
                    <input name="skuBrand" type="text" placeholder="小米" class="input-xlarge" id="input02" value="${phone.phoneBrand}">
                ...
                <div class="controls">
                    <input name="phonePrice" type="text" placeholder="1000.00" class="input-xlarge" value="${phone.phonePrice}">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="skuStock" type="text" placeholder="100" class="input-xlarge" value="${phone.phoneStock}">
